...
public class IndexController {
    ...
    public String index() {
        ...
        //뷰리졸버 설정 : templates (prefix), .mustache (suffix) application 파일에서 생략가
    ...
    //spring security 가 주소를 낚아챔 - SecurityConfig 파일 생성 후 작동안함
    ...
    public String join(User user) {
        ...
        userRepository.save(user); //회원가입 잘됨. 비밀번호 : 1234 -> 시큐리티로 로그인을 할 수 없음. 이유는 패스워드가 암호화가 안돼있기 때문
